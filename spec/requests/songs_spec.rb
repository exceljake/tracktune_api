...
RSpec.describe "/songs", type: :request do
  ...
  # SongsController, or in your router and rack
  ...
  describe "GET /index" do
    it "renders a successful response" do
      ...
      get songs_url, headers: valid_headers, as: :json
  ...
  describe "POST /create" do
    context "with valid parameters" do
      it "creates a new Song" do
        expect {
          post songs_url,
               params: { song: valid_attributes }, headers: valid_headers, as: :json
    ...
    context "with invalid parameters" do
      it "does not create a new Song" do
        expect {
          post songs_url,
               params: { song: invalid_attributes }, as: :json
        }.to change(Song, :count).by(0)
      end

      it "renders a JSON response with errors for the new song" do
        post songs_url,
             params: { song: invalid_attributes }, headers: valid_headers, as: :json
  ...
  describe "PATCH /update" do
    context "with valid parameters" do
      ...
      it "updates the requested song" do
        song = Song.create! valid_attributes
        patch song_url(song),
              params: { song: new_attributes }, headers: valid_headers, as: :json
        song.reload
  ...
  describe "DELETE /destroy" do
    it "destroys the requested song" do
      song = Song.create! valid_attributes
      expect {
        delete song_url(song), headers: valid_headers, as: :json
      }.to change(Song, :count).by(-1)
    end
  end
end
